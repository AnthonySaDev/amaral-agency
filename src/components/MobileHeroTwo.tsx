...
export default function MobileHeroTwo() {
  return (
    <>
    <div className="relative md:hidden flex-col items-center justify-between h-[50vh]">
      ...
      <div className="relative flex flex-col items-center justify-start py-20 h-full gap-8 z-10">  
        <p className='text-[16px] leading-[22px] text-center px-20 font-light text-[#656161]'>Tenha a ajuda que <strong className='font-bold'>você precisa</strong> para <strong className='font-bold'>criar</strong> o seu processo de <strong className='font-bold'>vendas</strong> através da internet e alcance o sucesso com uma assessoria especializada.</p>
        <Button
          className='min-w-[250px] min-h-[36px] my-10 rounded-[5px] py-5 bg-gradient-to-r to-[#FF003C] from-[#FF7E00] md:hidden flex items-center ml-5 z-50'
        >
          <p className='text-black text-[10px]'>Quero um time de marketing</p>
